...
link:concept_volume_behavior_during_switchover_and_switchback.html["Comportamiento del volumen durante la conmutación de sitios y la conmutación de estado"]
