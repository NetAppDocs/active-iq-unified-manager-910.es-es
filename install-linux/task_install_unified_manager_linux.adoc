...
`java -version`
 ...
 a| 
Edición comunitaria de MySQL 8.0.27
 a| 
`rpm -qa | grep -i mysql`
...
|===
. Si la versión instalada de MySQL es anterior a MySQL 8.0.27 Community Edition, introduzca el siguiente comando para desinstalarla:
+
