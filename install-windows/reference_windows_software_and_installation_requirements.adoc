...
* MySQL Community Edition versión 8.0.27
* Python 3.9.x
* OpenJDK versión 11.0.12
...
* Si tiene un software antivirus activo instalado en el sistema Windows, se podría producir un error en la instalación de Unified Manager. Debe deshabilitar todo el software de análisis de virus en el sistema antes de instalar Unified Manager. Una vez finalizada la instalación, asegúrese de excluir manualmente las siguientes rutas del análisis antivirus:
+
